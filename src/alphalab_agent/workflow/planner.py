...
class ResearchPlan:
    ...
    def to_config(self, base_config: ResearchConfig | None = None) -> ResearchConfig:
        ...
        return ResearchConfig(
            ...
            weighting_mode=base.weighting_mode,
            benchmark_seed=base.benchmark_seed,
            enable_supervised_model=base.enable_supervised_model,
            model_type=base.model_type,
            model_label_col=base.model_label_col,
            model_factor_cols=base.model_factor_cols,
            ...
            validation_splits=base.validation_splits,
            validation_train_fraction=base.validation_train_fraction,
            validation_embargo_periods=base.validation_embargo_periods,
            sensitivity_top_k_step=base.sensitivity_top_k_step,
            generate_manifest=base.generate_manifest,
